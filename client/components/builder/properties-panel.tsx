        ...
        <div className="p-3 space-y-4">
          ...
          {activeTab === "style" && (
            <>
              ...
              {selectedElement.type !== "modal" && selectedElement.type !== "cart" && selectedElement.type !== "checkout" && (
                <>
                  <Separator className="bg-sidebar-border" />
